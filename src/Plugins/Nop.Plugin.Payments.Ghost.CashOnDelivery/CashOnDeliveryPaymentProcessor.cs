...
namespace Nop.Plugin.Payments.Ghost.CashOnDelivery
{
    public class CashOnDeliveryPaymentProcessor: BasePlugin, IPaymentMethod
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                ["Plugin.Payments.Ghost.CashOnDelivery.AdditionalFee"] = "Additional fee",
                ["Plugin.Payments.Ghost.CashOnDelivery.AdditionalFee.Hint"] = "The additional fee.",
                ["Plugin.Payments.Ghost.CashOnDelivery.AdditionalFeePercentage"] = "Additional fee. Use percentage",
                ["Plugin.Payments.Ghost.CashOnDelivery.AdditionalFeePercentage.Hint"] = "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.",
                ["Plugin.Payments.Ghost.CashOnDelivery.ShippableProductRequired"] = "Shippable product required",
        ...
        public override async Task UninstallAsync()
        {
            ...
            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Plugin.Payments.Ghost.CashOnDelivery");
        ...
        {
            return await _localizationService.GetResourceAsync("Plugin.Payments.Ghost.CashOnDelivery.PaymentMethodDescription");
        }
        ...
        /// for example, for a redirection payment method, description may be like this: "You will be redirected to PayPal site to complete the payment"
        /// </remarks>
        public Task<string> PaymentMethodDescription => _localizationService.GetResourceAsync("Plugin.Payments.Ghost.CashOnDelivery.PaymentMethodDescription");
