...
namespace Nop.Plugin.DiscountRules.Ghost.MinCartAmount.Controllers;

[AuthorizeAdmin]
[Area(AreaNames.ADMIN)]
[AutoValidateAntiforgeryToken]
public class DiscountRulesMinCartAmountController : BasePluginController
{
    private readonly IDiscountService _discountService;
    private readonly IPermissionService _permissionService;
    private readonly ISettingService _settingService;

    public DiscountRulesMinCartAmountController(IDiscountService discountService,
    ...
    public async Task<IActionResult> Configure(int discountId, int? discountRequirementId)
    {
        ...
        var model = new RequirementModel
        {
            ...
            MinCartAmount = spentAmountRequirement
        };
        ...
        return View("~/Plugins/DiscountRules.Ghost.MinCartAmount/Views/Configure.cshtml", model);
    }
    ...
    public async Task<IActionResult> Configure(RequirementModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            await _settingService.SetSettingAsync(string.Format(DiscountRequirementDefaults.SETTINGS_KEY, discountRequirement.Id), model.MinCartAmount);
